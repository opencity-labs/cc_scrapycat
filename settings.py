...
class PluginSettings(BaseModel):
    ...
    cache_content: bool = Field(
        ...
        description="Reuse the HTML already fetched during crawling at ingestion time, avoiding a second request per page. Helps with sites that rate-limit rapid repeated requests.",
    )
